...
public class TableActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       autoComplete   = findViewById(R.id.tbl_img);
        ...
        Adapter dataAdapter = new Adapter(this, R.layout.spinner_values, countries, hidingItemIndex);
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.btn_submit) {
            ...
            if (validate()) {
                ...
                userlist.add(new User(name,dob,gender, country, email, phone,imageID));
